...
ps.index make subsetting simpler
df.set_index(["col_namea",'col_nameb'])
df.reset_index(drop=True)
df.loc[['variable_a','variable_b']] ..... subset on outer levels
df.loc[[('variable_a＿outer_layer','variable_a_inter_layer'),('variable_a＿outer_layer','variable_a_inter_layer')]]..... subset on inner levels
df.sort_index()
df.sort_index(level = ['color','breed'],ascending=[True,False]) .... passing list to change ascending
```
